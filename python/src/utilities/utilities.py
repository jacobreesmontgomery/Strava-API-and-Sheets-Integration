...
class Utilities:
    def get_index_of_key(self, dictionary, key_to_find):
        """
    ...
    def format_seconds(self, seconds: timedelta):
        """
    ...
    def calculate_pace(self, total_seconds, distance_miles):
        """
    ...
    def format_to_hhmmss(self, time_str):
        """
    ...
    def divide_time_by_number(self, time_str, divisor):
        """ """
    ...
    def divide_time_str_by_number(self, time_str, divisor):
        """ """
        total_seconds = self.time_str_to_seconds(time_str)
        divided_seconds = total_seconds / divisor
        return self.seconds_to_time_str(divided_seconds)

    def tally_time(self, run_times):
        """
